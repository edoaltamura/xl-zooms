...
def feedback_stats_dT(path_to_snap: str, path_to_catalogue: str) -> tuple:
    ...
    central_bh['x'] = np.ndarray([bh_coordX[central_bh_index]]) * bh_positions.units
    central_bh['y'] = np.ndarray([bh_coordY[central_bh_index]]) * bh_positions.units
    central_bh['z'] = np.ndarray([bh_coordZ[central_bh_index]]) * bh_positions.units
    central_bh['r'] = np.ndarray([bh_radial_distance[central_bh_index]]) * bh_positions.units
    central_bh['mass'] = np.ndarray([data.black_holes.dynamical_masses[central_bh_index]]) * data.black_holes.dynamical_masses.units
    central_bh['id'] = np.ndarray([data.black_holes.particle_ids[central_bh_index]])
    central_bh['redshift'] = np.ndarray([data.metadata.z])
