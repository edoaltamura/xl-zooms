...
for t in temperatures[snii_flag_z0p5]:
    axes.plot(redshifts, t, color='g', linewidth=0.1, alpha=0.2)
for t in temperatures[agn_flag_z0p5]:
    axes.plot(redshifts, t, color='r', linewidth=0.1, alpha=0.2)
