...
class CoolingTimes(HaloProperty):
    ...
    def process_single_halo(
        ...
        cbar = plt.colorbar(mappable, ax=axes[0, 0], cax=cax, format='%d')
        ...
        if (H > 0).any():
            ...
            cax = divider.append_axes("right", size="3%", pad=0.)
            cbar = plt.colorbar(mappable, ax=axes[0, 1], cax=cax, format='%d')
        ...
        if (H > 0).any():
            ...
            cax = divider.append_axes("right", size="3%", pad=0.)
            cbar = plt.colorbar(mappable, ax=axes[0, 2], cax=cax, format='%d')
        ...
        cax = divider.append_axes("right", size="3%", pad=0.)
        cbar = plt.colorbar(mappable, ax=axes[1, 1], cax=cax, format='%d')
        ...
        cax = divider.append_axes("right", size="3%", pad=0.)
        cbar = plt.colorbar(mappable, ax=axes[1, 0], cax=cax, format='%d')
