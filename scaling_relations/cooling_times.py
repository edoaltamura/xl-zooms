...
class CoolingTimes(HaloProperty):
    ...
    def process_single_halo(
        ...
        txt = AnchoredText("All particles", loc="upper right", linewidth=0, pad=0.4, borderpad=0, prop={"fontsize": 8})
        ...
        txt = AnchoredText("SNe heated only", loc="upper right", linewidth=0, pad=0.4, borderpad=0, prop={"fontsize": 8})
        ...
        txt = AnchoredText("Not heated by SN or AGN", loc="upper right", linewidth=0, pad=0.4, borderpad=0, prop={"fontsize": 8})
        ...
        txt = AnchoredText("AGN heated only", loc="upper right", linewidth=0, pad=0.4, borderpad=0, prop={"fontsize": 8})
        ...
        txt = AnchoredText("AGN and SNe heated", loc="upper right", linewidth=0, pad=0.4, borderpad=0, prop={"fontsize": 8})
