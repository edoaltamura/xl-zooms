...
class CoolingTimes(HaloProperty):
    ...
    def process_single_halo(
        ...
        axes[2, 0].hist(w[(~agn_flag & snii_flag)], histtype='step', label='SN')
        axes[2, 0].hist(w[(~agn_flag & ~snii_flag)], histtype='step', label='Not heated')
        ...
        axes[2, 1].hist(hydrogen_fraction[(~agn_flag & snii_flag)], histtype='step', label='SN')
        ...
        axes[2, 2].hist(log_gas_Z[(~agn_flag & snii_flag)], histtype='step', label='SN')
