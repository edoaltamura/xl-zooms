...
class CoolingTimes(HaloProperty):
    ...
    def process_single_halo(
        ...
        axes[0, 3].hist(values_to_int[:, 0][(agn_flag & snii_flag)], bins=50, histtype='step', label='AGN & SN')
        axes[0, 3].hist(values_to_int[:, 0][(agn_flag & ~snii_flag)], bins=50, histtype='step', label='AGN')
        axes[0, 3].hist(values_to_int[:, 0][(~agn_flag & snii_flag)], bins=50, histtype='step', label='SN')
        axes[0, 3].hist(values_to_int[:, 0][(~agn_flag & ~snii_flag)], bins=50, histtype='step', label='Not heated')
        ...
        axes[1, 3].hist(values_to_int[:, 1][(agn_flag & snii_flag)], bins=50, histtype='step', label='AGN & SN')
        axes[1, 3].hist(values_to_int[:, 1][(agn_flag & ~snii_flag)], bins=50, histtype='step', label='AGN')
        axes[1, 3].hist(values_to_int[:, 1][(~agn_flag & snii_flag)], bins=50, histtype='step', label='SN')
        axes[1, 3].hist(values_to_int[:, 1][(~agn_flag & ~snii_flag)], bins=50, histtype='step', label='Not heated')
        ...
        axes[2, 3].hist(values_to_int[:, 2][(agn_flag & snii_flag)], bins=50, histtype='step', label='AGN & SN')
        axes[2, 3].hist(values_to_int[:, 2][(agn_flag & ~snii_flag)], bins=50, histtype='step', label='AGN')
        axes[2, 3].hist(values_to_int[:, 2][(~agn_flag & snii_flag)], bins=50, histtype='step', label='SN')
        axes[2, 3].hist(values_to_int[:, 2][(~agn_flag & ~snii_flag)], bins=50, histtype='step', label='Not heated')
