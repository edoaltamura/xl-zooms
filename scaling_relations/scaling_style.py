...
style_subgrid_model = pd.DataFrame(
    [
        ['_-8res_MinimumDistance_fixedAGNdT7.5_Nheat1_SNnobirth', colors[0], '.', 23, '-', 1,
         Line2D([], [], marker='.', color=colors[0], markeredgecolor='none', linestyle='None', markersize=7, label=r'AGN: MinDist, $dT=10^{7.5}$ K')],
        ['_-8res_MinimumDistance_fixedAGNdT8_Nheat1_SNnobirth', colors[1], '.', 23, '-', 1,
         Line2D([], [], marker='.', color=colors[1], markeredgecolor='none', linestyle='None', markersize=7, label=r'AGN: MinDist, $dT=10^8$ K')],
        ['_-8res_MinimumDistance_fixedAGNdT8.5_Nheat1_SNnobirth', colors[2], '.', 23, '-', 1,
         Line2D([], [], marker='.', color=colors[2], markeredgecolor='none', linestyle='None', markersize=7, label=r'AGN: MinDist, $dT=10^{8.5}$ K')],
        ['_-8res_MinimumDistance_fixedAGNdT9_Nheat1_SNnobirth', colors[3], '.', 23, '-', 1,
         Line2D([], [], marker='.', color=colors[3], markeredgecolor='none', linestyle='None', markersize=7, label=r'AGN: MinDist, $dT=10^9$ K')],
        ['_-8res_MinimumDistance_fixedAGNdT9.5_Nheat1_SNnobirth', colors[4], '.', 23, '-', 1,
         Line2D([], [], marker='.', color=colors[4], markeredgecolor='none', linestyle='None', markersize=7, label=r'AGN: MinDist, $dT=10^{9.5}$ K')],

        ['_-8res_Isotropic_fixedAGNdT8_Nheat1_SNnobirth', colors[5], '.', 23, '-', 1,
         Line2D([], [], marker='.', color=colors[5], markeredgecolor='none', linestyle='None', markersize=7, label=r'AGN: Isotropic, $dT=10^8$ K')],
        ['_-8res_Isotropic_fixedAGNdT8.5_Nheat1_SNnobirth', colors[6], '.', 23, '-', 1,
         Line2D([], [], marker='.', color=colors[6], markeredgecolor='none', linestyle='None', markersize=7, label=r'AGN: Isotropic, $dT=10^{8.5}$ K')],
        ['_-8res_Isotropic_fixedAGNdT9_Nheat1_SNnobirth', colors[7], '.', 23, '-', 1,
         Line2D([], [], marker='.', color=colors[7], markeredgecolor='none', linestyle='None', markersize=7, label=r'AGN: Isotropic, $dT=10^9$ K')],

        ['_+1res_MinimumDistance_fixedAGNdT8_Nheat1_SNnobirth', colors[1], '^', 23, '-', 1,
         Line2D([], [], marker='^', color=colors[1], markeredgecolor='none', linestyle='None', markersize=5, label=r'AGN: MinDist, $dT=10^8$ K')],
        ['_+1res_MinimumDistance_fixedAGNdT8.5_Nheat1_SNnobirth', colors[2], '^', 23, '-', 1,
         Line2D([], [], marker='^', color=colors[2], markeredgecolor='none', linestyle='None', markersize=5, label=r'AGN: MinDist, $dT=10^{8.5}$ K')],
        ['_+1res_MinimumDistance_fixedAGNdT9_Nheat1_SNnobirth', colors[3], '^', 23, '-', 1,
         Line2D([], [], marker='^', color=colors[3], markeredgecolor='none', linestyle='None', markersize=5, label=r'AGN: MinDist, $dT=10^9$ K')],

        ['_+1res_Isotropic_fixedAGNdT8_Nheat1_SNnobirth', colors[5], '^', 23, '-', 1,
         Line2D([], [], marker='^', color=colors[5], markeredgecolor='none', linestyle='None', markersize=5, label=r'AGN: Isotropic, $dT=10^8$ K')],
        ['_+1res_Isotropic_fixedAGNdT8.5_Nheat1_SNnobirth', colors[6], '^', 23, '-', 1,
         Line2D([], [], marker='^', color=colors[6], markeredgecolor='none', linestyle='None', markersize=5, label=r'AGN: Isotropic, $dT=10^{8.5}$ K')],
        ['_+1res_Isotropic_fixedAGNdT9_Nheat1_SNnobirth', colors[7], '^', 23, '-', 1,
         Line2D([], [], marker='^', color=colors[7], markeredgecolor='none', linestyle='None', markersize=5, label=r'AGN: Isotropic, $dT=10^9$ K')],
