...
class IronProfiles(HaloProperty):
    ...
    def process_single_halo(
        ...
        index = np.where(
            ...
            (sw_data.gas.temperatures > tempHot)
        )[0]
        ...
        iron = sw_data.gas.element_mass_fractions.iron[index]

        iron_profile = histogram_unyt(
            radial_distance,
            bins=lbins,
            weights=iron,
        ...
        ironSolar = 0.00183  # Anders & Grevesse 1989

        return radial_bin_centres, iron_profile, ironSolar
